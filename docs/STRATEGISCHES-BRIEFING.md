...
deutschsprachige Prosa, **Chronik append-only** (osmanisches Defter, 85 Einträge), keine erfundenen Zahlen.
...
`build-book.yml` (CI: PDF/EPUB/Release) · `deploy-pages.yml` (CD: Pages) · `brain/CHRONIK.md` (Ledger, 85 Einträge) ·
